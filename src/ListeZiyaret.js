...
function ListeZiyaret({ paramSetVisitList }) {
  ...
  useEffect(async () => {
    ...
    if (paramSetVisitList != undefined) {
      paramSetVisitList(response.data[0].VisitTable);
    }
  }, [visitList.refresh]);
  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} fullWidth>
        <DialogContent>
          <GuncelleZiyaret paramSetOpen={setOpen} />
        </DialogContent>
      </Dialog>
      <Header />
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <a href="liste_Ziyaret.html">Ziyaret</a>
                <i className="fa fa-circle" />
              </li>
              <li className="active">Ziyaret Listesi</li>
            </ul>
            {/* END PAGE BREADCRUMB */}
                  ...
                  <div className="portlet-title">
                    ...
                    <div className="tools">
                      ...
                      <a
                        ...
                        className="reload"
                        onClick={() =>
                          setVisitList({ ...visitList, refresh: true })
                        }
                      ></a>
                  ...
                  <div className="portlet-body">
                    <div className="table-scrollable">
                      <table className="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
                            <th scope="col">Ziyaret tarihi</th>
                        ...
                        <tbody>
                          {visitList.visits.map((repo, index) => (
                            <tr key={index}>
                              <td>
                                <Link
                                  to={"?id=" + repo.VisitID}
