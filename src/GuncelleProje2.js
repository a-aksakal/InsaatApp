...
function GuncelleProje2() {
  ...
  const Send = async () => {
    ...
    if (response.data.Result == "İşlem Başarıyla Tamamlandı.") {
      ...
      //const aaa = params.get("id");
      //console.log(aaa);
      //console.log(searchParam.get("id"));

      console.log(projectList[searchParam.get("id") - 1]);
    } else {
                        ...
                        <div className="form-group">
                          ...
                          <input
                            ...
                            value={projectList
                              .filter(
                                (repo) =>
                                  repo.ProjectID == searchParam.get("id")
                              )
