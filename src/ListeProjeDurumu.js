  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} fullWidth>
        <DialogContent>
          <GuncelleProjeDurumu paramSetOpen={setOpen} />
        </DialogContent>
      </Dialog>
      <Dialog open={openAdd} onClose={handleCloseAdd} fullWidth>
        <DialogContent>
          <FormProjeDurumu paramSetOpenAdd={setOpenAdd} />
        </DialogContent>
      </Dialog>
      <Header />
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <a href="liste_ProjeDurumu.html">Proje Durumu</a>
                <i className="fa fa-circle" />
              </li>
                  ...
                  <div className="portlet-title">
                    ...
                    <div className="tools">
                      ...
                      <a
                        ...
                        className="reload"
                        onClick={() =>
                          setProjectStatus({ ...projectStatus, refresh: true })
                        }
                      ></a>
                  ...
                  <div className="portlet-body">
                    <div className="table-scrollable">
                      <table className="table table-striped table-bordered table-advance table-hover">
                        <tbody>
                          {projectStatus.projectStatuses.map((repo, index) => (
                            <tr key={repo.ProjectStatusID}>
                              <td
                                className="highlight"
                                style={{ width: "30%" }}
                              >
                                <div className="success"></div>
                                <a href="#">{repo.ProjectStatusName} </a>
                              </td>
                              <td>
                                <Link
                                  to={"?id=" + repo.ProjectStatusID}
                                ...
                                <Link
                                  ...
                                  onClick={() => Sil(repo.ProjectStatusID)}
                                >
...
export default ListeProjeDurumu;
