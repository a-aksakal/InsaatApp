  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} fullWidth>
        <DialogContent>
          <GuncelleSehir paramSetOpen={setOpen} />
        </DialogContent>
      </Dialog>
      <Dialog open={openAdd} onClose={handleCloseAdd} fullWidth>
        <DialogContent>
          <FormSehir paramSetOpenAdd={setOpenAdd} />
        </DialogContent>
      </Dialog>
      <Header />
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <a href="liste_Sehir.html">Şehir</a>
                <i className="fa fa-circle" />
              </li>
              <li className="active">Şehir Listesi</li>
            </ul>
            {/* END PAGE BREADCRUMB */}
                  ...
                  <div className="portlet-title">
                    ...
                    <div className="tools">
                      ...
                      <a
                        ...
                        className="reload"
                        onClick={() =>
                          setCityList({ ...cityList, refresh: true })
                        }
                      ></a>
                  ...
                  <div className="portlet-body">
                    <div className="table-scrollable">
                      <table className="table table-striped table-bordered table-advance table-hover">
                        <tbody>
                          {cityList.cities.map((repo, index) => (
                            <tr key={repo.CityID}>
                              <td
                                className="highlight"
                                style={{ width: "25%" }}
