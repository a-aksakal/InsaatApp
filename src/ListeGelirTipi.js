...
import GuncelleGelirTipi from "./GuncelleGelirTipi";
  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} fullWidth>
        <DialogContent>
          <GuncelleGelirTipi paramSetOpen={setOpen} />
        </DialogContent>
      </Dialog>
      <Dialog open={openAdd} onClose={handleCloseAdd} fullWidth>
        <DialogContent>
          <FormGelirTipi paramSetOpenAdd={setOpenAdd} />
        </DialogContent>
      </Dialog>
      <Header />
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <a href="liste_GelirTipi.html">Gelir Tipi</a>
                <i className="fa fa-circle" />
              </li>
              <li className="active">Gelir Tipi Listesi</li>
            </ul>
            {/* END PAGE BREADCRUMB */}
                  ...
                  <div className="portlet-title">
                    ...
                    <div className="tools">
                      ...
                      <a
                        ...
                        className="reload"
                        onClick={() =>
                          setIncomeType({ ...incomeType, refresh: true })
                        }
                      ></a>
                  ...
                  <div className="portlet-body">
                    <div className="table-scrollable">
                      <table className="table table-striped table-bordered table-advance table-hover">
                        <tbody>
                          {incomeType.incomeTypes.map((repo, index) => (
                            <tr key={repo.IncomeTypeID}>
                              <td className="highlight">
                                <div className="success"></div>
                                <a href="#">{repo.IncomeTypeName} </a>
                              </td>
                              <td>
                                <Link
                                  to={"?id=" + repo.IncomeTypeID}
