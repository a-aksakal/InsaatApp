...
import GuncelleMusteri from "./GuncelleMusteri";
  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} fullWidth>
        <DialogContent>
          <GuncelleMusteri paramSetOpen={setOpen} />
        </DialogContent>
      </Dialog>
      <Header />
                  ...
                  <div className="portlet-title">
                    ...
                    <div className="tools">
                      ...
                      <a
                        ...
                        className="reload"
                        onClick={() =>
                          setCustomerList({ ...customerList, refresh: true })
                        }
                      ></a>
                      ...
                      <table className="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th scope="col">Gelir Durumu</th>
                            <th scope="col">Oluşturma Tarihi</th>
                            <th scope="col">İşlemler</th>
                          </tr>
                        </thead>
                        <tbody>
                          {customerList.customers.map((repo, index) => (
                            <tr key={index}>
                              <td>
                                <Link
                                  to={"?id=" + repo.CustomerID}
                              ...
                              <td>{repo.CustomerSurname}</td>
                              <td>{repo.TC}</td>
                              <td>{repo.BirthDate}</td>
                              <td>{repo.EMail}</td>
                              <td>{repo.GenderName}</td>
                              <td>{repo.GSM}</td>
                              <td>{repo.Address}</td>
                              <td>{repo.CityName}</td>
                              <td>{repo.IncomeTypeName}</td>
