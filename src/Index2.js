                    ...
                    >
                      <div className="btn-toolbar margin-bottom-10">
                        ...
                        <div className="btn-group pull-right">
                          ...
                          <ul className="dropdown-menu pull-right">
                            <li>
                              <a href="#" id="regional_stat_world">
                                World{" "}
                              </a>
                            </li>
                            <li>
                              <a href="#" id="regional_stat_usa">
                                USA{" "}
                              </a>
                            </li>
                            <li>
                              <a href="#" id="regional_stat_europe">
                                Europe{" "}
                              </a>
                            </li>
                            <li>
                              <a href="#" id="regional_stat_russia">
                                Russia{" "}
                              </a>
                            </li>
                            <li>
                              <a href="#" id="regional_stat_germany">
                                Germany{" "}
                              </a>
                            </li>
                          </ul>
                      ...
                      <ul className="list-items borderless">
                        <li>
                          ...
                          <select className="form-control input-inline input-sm input-small">
                            ...
                            <option value={2} defaultValue="defaultValue">
                              Medium
                            </option>
